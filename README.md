...
<p align="left">The death toll was had a high variety across the 17 years of data accumulated. There were major peaks and valleys with the highest increase occuring in 2011. It is unclear to say that there is a clear trend upwards or downwards.</p>
<br>
<br>
<br>
<br>
...
- Several microbes can be transmitted in a variety of different ways through fomites, people, contaminants, etc. It would be wise to categorize the most common ways the microbes are transmitted and develop a plan to mitigate these transmissions. For example, Since <em>E. coli (STEC)</em> is usually transmitted via animal feces, it might be useful for food locations to be cognizant of washing certain foods such as fruits and vegetables. E. coli (STEC) is the 2nd common reason for hospitalization which is expected due to the simplicity of transmission. You can acquire this illness via contaminated food/ water and/or poor hand hygiene. Listeria can be spread via contaminated food and even in the fridge so it is important to remember hygiene/food safety because people would assume refrigerated foods would be safe from foodborne illness. A campaign reminding consumers about certain bacterial strains and how they can infect people would be useful.
